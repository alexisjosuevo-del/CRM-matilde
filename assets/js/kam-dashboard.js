...
(function () {
  ...
  window.renderKPIs = function (kamName) {
    ...
    container.innerHTML = 
      makeCard('blue', '🏢', k.totalMed.toLocaleString('es-MX'), 'Clientes en Cartera', `<span class="kpi-delta up">↑ ${k.medActivos} activos (30d)</span>`, 'medicos');
  };
